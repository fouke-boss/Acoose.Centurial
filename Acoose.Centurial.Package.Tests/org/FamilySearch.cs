...
namespace Acoose.Centurial.Package.Tests.org
{
    ...
    public class FamilySearch
    {
        ...
        private void Image(string url, string collectionTitle, string path, string citing, [CallerMemberName] string caseName = null)
        {
            // init
            var result = Utility.ExecuteTest<Package.org.FamilySearch>(url, caseName: caseName);
        ...
        private void Record(string url, string collectionTitle, string entryFor, string citing, [CallerMemberName] string caseName = null)
        {
            // init
            var result = Utility.ExecuteTest<Package.org.FamilySearch>(url, caseName: caseName);
            var website = result.Source.Provenance
